...
const {STATUS_MAP} = require("../database/status_map");
/**
...
const processExcelBuffer = async (fileBuffer) => {
  ...
  if (reportTitle.includes("पासपोर्ट  सत्यापन")) {
    // return await processPassportVerification(rows, workbook);
  }

  throw new Error(`Unsupported report type: ${reportTitle}`);
};


const processCharacterVerification = async (rows, workbook) => {

  // Your complete existing code starts here
  console.log("Processing Character Verification Report...");
...
const charactersDatabase = async (data) => {
...
const processEmployeeVerification = async (rows, workbook) => {

  // Your complete existing code starts here
  console.log("Processing Employee Verification Report...");
...
const emplooyeesDatabase = async (data) => {
...
const processTenantVerification = async (rows, workbook) => {
...
const tenantDatabase = async (data) => {
...
const processDomesticVerification = async (rows, workbook) => {
...
const domesticDatabase = async (data) => {
